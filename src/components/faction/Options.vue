<template>
  <n-scrollbar trigger="none">
    <n-space vertical>
      ...
      >
        <p v-if="faction === 'sun'"><span style="color: #264653; font-weight: bold;">RADIANT LADY</span>: <a href="https://github.com/pbr4ne" :class="[`link-${faction}`]" target="_blank">pbrane</a></p>
